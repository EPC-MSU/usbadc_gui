"""
Project generated by builder 0.10.9 protocol 1.0.0
"""
import logging
...
from ctypes import c_int, c_void_p, c_wchar_p, c_size_t, c_char_p
import atexit
try:
...
urpc_builder_version_bugfix = 9
urpc_builder_version_suffix = ""
urpc_builder_version = "0.10.9"
_Ok = 0
_Error = -1
_NotImplemented = -2
_ValueError = -3
