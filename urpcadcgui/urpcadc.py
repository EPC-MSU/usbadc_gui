"""
Project generated by builder 0.10.4 protocol 0.1.5
"""
import logging
...
urpc_builder_version_bugfix = 4
urpc_builder_version_suffix = ""
urpc_builder_version = "0.10.4"
_Ok = 0
_Error = -1
_NotImplemented = -2
_ValueError = -3
...
def _load_lib():
    ...
    if os_kind == "windows":
        if 8 * struct.calcsize("P") == 32:
            paths = (_near_script_path("urpcadc-win32\\urpcadc.dll"), "urpcadc.dll")
        else:
            paths = (_near_script_path("urpcadc-win64\\urpcadc.dll"), "urpcadc.dll")
    elif os_kind == "darwin":
        paths = (_near_script_path("urpcadc-darwin/liburpcadc.dylib"), "liburpcadc.dylib")
    elif os_kind == "freebsd" or "linux" in os_kind:
        paths = (_near_script_path("urpcadc-debian/liburpcadc.so"), "liburpcadc.so")
    else:
...
_lib.urpcadc_open_device.restype = _device_t
...
def reset_locks():
    _validate_call(_lib.urpcadc_reset_locks())


def fix_usbser_sys():
    _validate_call(_lib.urpcadc_fix_usbser_sys())


class UrpcadcDeviceHandle:
    def save_settings(self) -> None:
        _validate_call(_lib.urpcadc_save_settings(self._handle))

    def read_settings(self) -> None:
        _validate_call(_lib.urpcadc_read_settings(self._handle))
    ...
    def get_identity_information(self, **kwargs) -> "GetIdentityInformationResponse":
        ...
        _validate_call(_lib.urpcadc_get_identity_information(self._handle, byref(dst_buffer)))
        return dst_buffer

    def reboot_to_bootloader(self) -> None:
        _validate_call(_lib.urpcadc_reboot_to_bootloader(self._handle))
    ...
    def debug_read(self, **kwargs) -> "DebugReadResponse":
        ...
        _validate_call(_lib.urpcadc_debug_read(self._handle, byref(dst_buffer)))
        return dst_buffer
    ...
    def debug_write(self, *args) -> None:  # noqa: F811
        ...
        if len(args) != 1 or not isinstance(args[0], self.DebugWriteRequest):
            ...
            src_buffer = args[0]
        _validate_call(_lib.urpcadc_debug_write(self._handle, byref(src_buffer)))

    def reset(self) -> None:
        _validate_call(_lib.urpcadc_reset(self._handle))

    def update_firmware(self) -> None:
        _validate_call(_lib.urpcadc_update_firmware(self._handle))
    ...
    def get_conversion_raw(self, **kwargs) -> "GetConversionRawResponse":
        ...
        _validate_call(_lib.urpcadc_get_conversion_raw(self._handle, byref(dst_buffer)))
        return dst_buffer
    ...
    def get_conversion(self, **kwargs) -> "GetConversionResponse":
        ...
        _validate_call(_lib.urpcadc_get_conversion(self._handle, byref(dst_buffer)))
        return dst_buffer
    ...
    def get_calibration_settings(self, **kwargs) -> "CalibrationSettingsResponse":
        ...
        _validate_call(_lib.urpcadc_get_calibration_settings(self._handle, byref(dst_buffer)))
        return dst_buffer
    ...
    def set_calibration_settings(self, *args) -> None:  # noqa: F811
        ...
        if len(args) != 1 or not isinstance(args[0], self.CalibrationSettingsRequest):
            ...
            src_buffer = args[0]
        _validate_call(_lib.urpcadc_set_calibration_settings(self._handle, byref(src_buffer)))
    ...
    def open_device(self):
        ...
        handle = _lib.urpcadc_open_device(self._uri)
    ...
    def lib_version(self):
        ...
        result = _lib.urpcadc_libversion(ver_lib)
    ...
    def close_device(self):
        ...
        try:
            result = _lib.urpcadc_close_device(byref(self._handle))
            _validate_call(result)
        except Exception as e:
            raise e
        else:
    ...
    def get_profile(self):
        ...
        _validate_call(_lib.urpcadc_get_profile(self._handle, byref(buffer), allocate))
        return buffer.value.decode("utf-8")

    def set_profile(self, source):
        if isinstance(source, str):
            source = source.encode("utf-8")
        _validate_call(_lib.urpcadc_set_profile(self._handle, c_char_p(source), len(source)))
